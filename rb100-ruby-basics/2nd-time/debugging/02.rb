...
# Example previously had sunshine = ['true', 'false'], which are Strings that are always truthy unless explicitly declared otherwise. To fix this, just remove the apostrophes to make them true and false.
